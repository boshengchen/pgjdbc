...
public interface PGConnection {
  ...
  /**
   * This allows client code to add a handler for one of org.kmdsql's more unique data types. It
  ...
  /**
   * <p>This allows client code to add a handler for one of org.kmdsql's more unique data types.</p>
   *
   ...
   * <pre>
   * ...
   * ((org.kmdsql.PGConnection)myconn).addDataType("mytype", my.class.name.class);
   * ...
   * </pre>
   *
   * <p>where myconn is an open Connection to org.kmdsql.</p>
   *
   * <p>The handling class must extend org.kmdsql.util.PGobject</p>
   *
   ...
   *        implement {@link org.kmdsql.util.PGobject}).
   * @throws SQLException if <code>klass</code> does not implement
   *         {@link org.kmdsql.util.PGobject}).
   * @see org.kmdsql.util.PGobject
   * @since 8.0
   */
   ...
   * {@link org.kmdsql.PGStatement#setPrepareThreshold(int)} for details.
   *
