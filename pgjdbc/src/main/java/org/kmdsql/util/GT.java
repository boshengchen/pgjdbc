...
public class GT {
  ...
  private GT() {
    try {
      ...
      bundle = ResourceBundle.getBundle("org.kmdsql.translation.messages");
      //#else
      bundle = ResourceBundle.getBundle("org.kmdsql.translation.messages", Locale.getDefault(Locale.Category.DISPLAY));
      //#endif
