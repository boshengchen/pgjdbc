...
public class PGJDBCMain {
  ...
  public static void main(String[] args) {
    ...
    java.net.URL url = Driver.class.getResource("/org.kmdsql/Driver.class");
    System.out.printf("%n%s%n", org.kmdsql.util.DriverInfo.DRIVER_FULL_NAME);
    ...
    System.out.printf("The PgJDBC driver is not an executable Java program.%n%n"
                       ...
                       + "then use it by specifying a JDBC URL of the form %n    jdbc:kmdsql://%n"
