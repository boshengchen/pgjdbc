...
public class PGBundleActivator implements BundleActivator {
  ...
  public void start(BundleContext context) throws Exception {
    ...
    properties.put(DataSourceFactory.OSGI_JDBC_DRIVER_NAME, org.kmdsql.util.DriverInfo.DRIVER_NAME);
    properties.put(DataSourceFactory.OSGI_JDBC_DRIVER_VERSION, org.kmdsql.util.DriverInfo.DRIVER_VERSION);
    try {
