...
import org.kmdsql.jdbc2.ArrayAssistantRegistry;
...
public class PgArray implements java.sql.Array {
  ...
  public Object getArrayImpl(long index, int count, Map<String, Class<?>> map) throws SQLException {
    ...
    if (map != null && !map.isEmpty()) {
      throw org.kmdsql.Driver.notImplemented(this.getClass(), "getArrayImpl(long,int,Map)");
    }
  ...
  private Class<?> elementOidToClass(int oid) throws SQLException {
    switch (oid) {
      ...
      default:
        ...
        throw org.kmdsql.Driver.notImplemented(this.getClass(), "readBinaryArray(data,oid)");
    }
  }
  ...
  public ResultSet getResultSetImpl(long index, int count, Map<String, Class<?>> map)
    ...
    // for now maps aren't supported.
    if (map != null && !map.isEmpty()) {
      throw org.kmdsql.Driver.notImplemented(this.getClass(), "getResultSetImpl(long,int,Map)");
    }
