...
public class PgClob extends AbstractBlobClob implements java.sql.Clob {
  ...
  public PgClob(org.kmdsql.core.BaseConnection conn, long oid) throws java.sql.SQLException {
    super(conn, oid);
  }

  public synchronized Reader getCharacterStream(long pos, long length) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "getCharacterStream(long, long)");
  }

  public synchronized int setString(long pos, String str) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "setString(long,str)");
  }

  public synchronized int setString(long pos, String str, int offset, int len) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "setString(long,String,int,int)");
  }

  public synchronized java.io.OutputStream setAsciiStream(long pos) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "setAsciiStream(long)");
  }

  public synchronized java.io.Writer setCharacterStream(long pos) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "setCharacteStream(long)");
  }
  ...
  public synchronized long position(String pattern, long start) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "position(String,long)");
  }
  ...
  public synchronized long position(Clob pattern, long start) throws SQLException {
    checkFreed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "position(Clob,start)");
  }
}
