...
import org.kmdsql.PGNotification;
...
import org.kmdsql.core.ConnectionFactory;
import org.kmdsql.core.Encoding;
import org.kmdsql.core.Oid;
import org.kmdsql.core.Provider;
import org.kmdsql.core.Query;
import org.kmdsql.core.QueryExecutor;
import org.kmdsql.core.ReplicationProtocol;
import org.kmdsql.core.ResultHandlerBase;
import org.kmdsql.core.ServerVersion;
import org.kmdsql.core.SqlCommand;
import org.kmdsql.core.TransactionState;
import org.kmdsql.core.TypeInfo;
import org.kmdsql.core.Utils;
import org.kmdsql.core.Version;
import org.kmdsql.fastpath.Fastpath;
import org.kmdsql.largeobject.LargeObjectManager;
import org.kmdsql.replication.PGReplicationConnection;
import org.kmdsql.replication.PGReplicationConnectionImpl;
import org.kmdsql.util.GT;
import org.kmdsql.util.HostSpec;
import org.kmdsql.util.LruCache;
import org.kmdsql.util.PGBinaryObject;
...
public class PgConnection implements BaseConnection {
  ...
  public PgConnection(HostSpec[] hostSpecs,
    ...
    LOGGER.log(Level.FINE, org.kmdsql.util.DriverInfo.DRIVER_FULL_NAME);
  ...
  /*
   * This method is used internally to return an object based around org.kmdsql's more unique
   * data types.
   *
   * <p>It uses an internal HashMap to get the handling class. If the type is not supported, then an
   * instance of org.kmdsql.util.PGobject is returned.
   *
  ...
  public Object getObject(String type, String value, byte[] byteValue) throws SQLException {
    ...
    try {
      ...
      // This is used to implement the org.kmdsql unique types (like lseg,
      // point, etc).
  ...
  private void initObjectTypes(Properties info) throws SQLException {
    ...
    addDataType("box", org.kmdsql.geometric.PGbox.class);
    addDataType("circle", org.kmdsql.geometric.PGcircle.class);
    addDataType("line", org.kmdsql.geometric.PGline.class);
    addDataType("lseg", org.kmdsql.geometric.PGlseg.class);
    addDataType("path", org.kmdsql.geometric.PGpath.class);
    addDataType("point", org.kmdsql.geometric.PGpoint.class);
    addDataType("polygon", org.kmdsql.geometric.PGpolygon.class);
    addDataType("money", org.kmdsql.util.PGmoney.class);
    addDataType("interval", org.kmdsql.util.PGInterval.class);
  ...
  public Clob createClob() throws SQLException {
    checkClosed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "createClob()");
  }

  @Override
  public Blob createBlob() throws SQLException {
    checkClosed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "createBlob()");
  }

  @Override
  public NClob createNClob() throws SQLException {
    checkClosed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "createNClob()");
  }
  ...
  public Struct createStruct(String typeName, Object[] attributes) throws SQLException {
    checkClosed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "createStruct(String, Object[])");
  }
  ...
  public <T> T createQueryObject(Class<T> ifc) throws SQLException {
    checkClosed();
    throw org.kmdsql.Driver.notImplemented(this.getClass(), "createQueryObject(Class<T>)");
  }
