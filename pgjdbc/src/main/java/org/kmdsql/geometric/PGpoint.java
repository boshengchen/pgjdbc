...
/**
 * <p>It maps to the point datatype in org.kmdsql.</p>
 *
...
public class PGpoint extends PGobject implements PGBinaryObject, Serializable, Cloneable {
  ...
  /**
   * @return the PGpoint in the syntax expected by org.kmdsql
   */
  ...
  /**
   * Populate the byte array with PGpoint in the binary syntax expected by org.kmdsql.
   */
