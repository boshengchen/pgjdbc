...
import org.kmdsql.util.DriverInfo;
...
import org.kmdsql.util.SharedTimer;
 ...
 *
 * @see org.kmdsql.PGConnection
 * @see java.sql.Driver
 */
public class Driver implements java.sql.Driver {

  private static Driver registeredDriver;
  private static final Logger PARENT_LOGGER = Logger.getLogger("org.kmdsql");
  private static final Logger LOGGER = Logger.getLogger("org.kmdsql.Driver");
  ...
  private Properties loadDefaultProperties() throws IOException {
    ...
    if (cl == null) {
      LOGGER.log(Level.WARNING, "Can't find a classloader for the Driver; not loading driver "
          + "configuration from org.kmdsql/driverconfig.properties");
    ...
    Enumeration<URL> urlEnum = cl.getResources("org.kmdsql/driverconfig.properties");
   ...
   *
   * <pre>
   *  jdbc:kmdsql://host:port/database?param1=val1&amp;...
   * </pre>
   *
  ...
  public Connection connect(String url, Properties info) throws SQLException {
    ...
    try {
      ...
      // org.kmdsql.unusual error will be returned instead.
      throw ex1;
   ...
   * don't. Our protocols start with jdbc:kmdsql:
   *
  ...
  public int getMajorVersion() {
    return org.kmdsql.util.DriverInfo.MAJOR_VERSION;
  }

  @Override
  public int getMinorVersion() {
    return org.kmdsql.util.DriverInfo.MINOR_VERSION;
  }
  ...
  public static Properties parseURL(String url, Properties defaults) {
    ...
    if (!urlServer.startsWith("jdbc:kmdsql:")) {
      LOGGER.log(Level.FINE, "JDBC URL must start with \"jdbc:kmdsql:\" but was: {0}", url);
      return null;
    }
    urlServer = urlServer.substring("jdbc:kmdsql:".length());
