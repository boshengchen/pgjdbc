...
package org.kmdsql.ds.common;

import org.kmdsql.ds.PGConnectionPoolDataSource;
import org.kmdsql.ds.PGPoolingDataSource;
...
public class PGObjectFactory implements ObjectFactory {
  ...
  public Object getObjectInstance(Object obj, Name name, Context nameCtx,
    ...
    if (className.equals("org.kmdsql.ds.PGSimpleDataSource")
        || className.equals("org.kmdsql.jdbc2.optional.SimpleDataSource")
        || className.equals("org.kmdsql.jdbc3.Jdbc3SimpleDataSource")) {
      return loadSimpleDataSource(ref);
    } else if (className.equals("org.kmdsql.ds.PGConnectionPoolDataSource")
        || className.equals("org.kmdsql.jdbc2.optional.ConnectionPool")
        || className.equals("org.kmdsql.jdbc3.Jdbc3ConnectionPool")) {
      return loadConnectionPool(ref);
    } else if (className.equals("org.kmdsql.ds.PGPoolingDataSource")
        || className.equals("org.kmdsql.jdbc2.optional.PoolingDataSource")
        || className.equals("org.kmdsql.jdbc3.Jdbc3PoolingDataSource")) {
