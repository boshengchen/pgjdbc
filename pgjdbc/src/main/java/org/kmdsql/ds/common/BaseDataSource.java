...
public abstract class BaseDataSource implements CommonDataSource, Referenceable {
  ...
  static {
    try {
      Class.forName("org.kmdsql.Driver");
    } catch (ClassNotFoundException e) {
      throw new IllegalStateException(
        "BaseDataSource is unable to load org.kmdsql.Driver. Please check if you have proper PostgreSQL JDBC Driver jar on the classpath",
        e);
    }
  }
  ...
  public void setUrl(String url) {
    ...
    Properties p = org.kmdsql.Driver.parseURL(url, null);
  ...
  public java.util.logging.Logger getParentLogger() {
    return Logger.getLogger("org.kmdsql");
  }
  //#endif
