...
package org.kmdsql.core.v3;

import org.kmdsql.PGProperty;
import org.kmdsql.core.ConnectionFactory;
import org.kmdsql.core.PGStream;
import org.kmdsql.core.QueryExecutor;
import org.kmdsql.core.ServerVersion;
import org.kmdsql.core.SetupQueryRunner;
import org.kmdsql.core.SocketFactoryFactory;
import org.kmdsql.core.Utils;
import org.kmdsql.core.Version;
import org.kmdsql.hostchooser.CandidateHost;
import org.kmdsql.hostchooser.GlobalHostStatusTracker;
import org.kmdsql.hostchooser.HostChooser;
import org.kmdsql.hostchooser.HostChooserFactory;
import org.kmdsql.hostchooser.HostRequirement;
import org.kmdsql.hostchooser.HostStatus;
import org.kmdsql.jdbc.SslMode;
import org.kmdsql.sspi.ISSPIClient;
import org.kmdsql.util.GT;
import org.kmdsql.util.HostSpec;
import org.kmdsql.util.MD5Digest;
import org.kmdsql.util.PSQLException;
import org.kmdsql.util.PSQLState;
import org.kmdsql.util.ServerErrorMessage;
...
public class ConnectionFactoryImpl extends ConnectionFactory {
  ...
  private ISSPIClient createSSPI(PGStream pgStream,
    ...
    try {
      ...
      Class<ISSPIClient> c = (Class<ISSPIClient>) Class.forName("org.kmdsql.sspi.SSPIClient");
      ...
      throw new IllegalStateException("Unable to load org.kmdsql.sspi.SSPIClient."
  ...
  private PGStream enableSSL(PGStream pgStream, SslMode sslMode, Properties info,
    ...
    switch (beresp) {
      ...
      case 'S':
        ...
        // Server supports ssl
        org.kmdsql.ssl.MakeSSL.convert(pgStream, info);
        return pgStream;
  ...
  private void doAuthentication(PGStream pgStream, String host, String user, Properties info) throws IOException, SQLException {
    ...
    org.kmdsql.jre7.sasl.ScramAuthenticator scramAuthenticator = null;
    //#endif
            ...
            switch (areq) {
              ...
              case AUTH_REQ_SSPI:
                ...
                if (useSSPI) {
                  ...
                  org.kmdsql.gss.MakeGSS.authenticate(pgStream, host, user, password,
              ...
              case AUTH_REQ_SASL:
                ...
                //#if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.1"
                scramAuthenticator = new org.kmdsql.jre7.sasl.ScramAuthenticator(user, password, pgStream);
