...
import org.kmdsql.jdbc.EscapedFunctions2;
...
public class Parser {
  ...
  public static JdbcCallParseInfo modifyJdbcCall(String jdbcSql, boolean stdStrings,
    ...
    // RE: frequently used statements are cached (see {@link org.kmdsql.jdbc.PgConnection#borrowQuery}), so this "merge" is not that important.
    String sql = jdbcSql;
