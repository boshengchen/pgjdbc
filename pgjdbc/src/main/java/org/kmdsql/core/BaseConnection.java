...
import org.kmdsql.jdbc.FieldMetadata;
...
public interface BaseConnection extends PGConnection, Connection {
   ...
   * the types registered via {@link org.kmdsql.PGConnection#addDataType(String, Class)} and
   * {@link org.kmdsql.PGConnection#addDataType(String, String)}.</p>
   *
   * <p>If no class is registered as handling the given type, then a generic
   * {@link org.kmdsql.util.PGobject} instance is returned.</p>
   *
